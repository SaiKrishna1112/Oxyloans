...
const submitfunction=props=>{
  ...
  .then(function (response) {
            setTimeout(function(){
             setLoading(false);
             console.log(response.data);
             alert("Your Withdrawal Request has been saved Succesfully");
...
const addfunction=props=>{
  ...
  .then(function (response) {
            setTimeout(function(){
             setLoading(false);
             console.log(response.data);
             alert("Your Withdrawal Request has been saved Succesfully Sucessfully.Total Withdrawal Request is"+response.data.amount);
...
// var totalamount=response.data.amount+withdrawamount;
 ...
 { text: "OK", onPress: () => setLoading(false) }
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.header}>Withdraw Amount</Text>
